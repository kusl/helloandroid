package com.appspot.kushhada.helloworld.helloworld;
 ...
 * {@link StudentListFragment} and the item details
 * (if present) is a {@link StudentDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link StudentListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class StudentListActivity extends FragmentActivity
        implements StudentListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.student_detail_container) != null) {
            ...
            ((StudentListFragment) getSupportFragmentManager()
                    .findFragmentById(R.id.student_list))
    ...
    /**
     * Callback method from {@link StudentListFragment.Callbacks}
